...
Middle Man는 [[code-smells]] 중 하나로, 클래스가 의미 있는 책임 없이 대부분의 호출을 다른 객체에 위임만 하는 상태.
...
- 후보 technique: `Remove Middle Man`, `Inline Method`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/middle-man
