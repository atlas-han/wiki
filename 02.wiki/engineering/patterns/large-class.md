...
Large Class는 [[code-smells]] 중 하나로, 한 클래스가 필드·메서드·책임을 과도하게 많이 떠안은 상태.
...
- 후보 technique: `Extract Class`, `Extract Subclass`, `Extract Interface`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/large-class
