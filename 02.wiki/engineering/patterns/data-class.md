...
Data Class는 [[code-smells]] 중 하나로, 데이터 필드와 단순 getter/setter만 있고 의미 있는 행동이 없는 클래스.
...
- 후보 technique: `Move Method`, `Encapsulate Field`, `Hide Method`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/data-class
