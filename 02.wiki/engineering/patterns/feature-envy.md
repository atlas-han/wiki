...
Feature Envy는 [[code-smells]] 중 하나로, 메서드가 자기 객체보다 다른 객체의 데이터에 더 관심을 보이는 상태.
...
- 후보 technique: `Move Method`, `Extract Method`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/feature-envy
