...
Duplicate Code는 [[code-smells]] 중 하나로, 동일하거나 거의 동일한 코드 조각이 여러 위치에 존재하는 상태.
...
- 후보 technique: `Extract Method`, `Pull Up Method`, `Form Template Method`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/duplicate-code
