...
Message Chains는 [[code-smells]] 중 하나로, 클라이언트가 객체 그래프를 따라 연쇄 호출하며 내부 구조를 알아야 하는 상태.
...
- 후보 technique: `Hide Delegate`, `Extract Method`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/message-chains
