...
Shotgun Surgery는 [[code-smells]] 중 하나로, 작은 기능 변경 하나가 여러 클래스의 작은 수정으로 흩어지는 상태.
...
- 후보 technique: `Move Method`, `Move Field`, `Inline Class`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/shotgun-surgery
