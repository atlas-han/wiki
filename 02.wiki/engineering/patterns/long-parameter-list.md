...
Long Parameter List는 [[code-smells]] 중 하나로, 메서드 호출에 필요한 파라미터가 지나치게 많아 호출자와 구현이 강하게 결합된 상태.
...
- 후보 technique: `Introduce Parameter Object`, `Preserve Whole Object`, `Replace Parameter with Method Call`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/long-parameter-list
