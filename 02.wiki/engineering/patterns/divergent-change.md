...
Divergent Change는 [[code-smells]] 중 하나로, 한 클래스가 서로 다른 변경 이유들 때문에 계속 수정되는 상태.
...
- 후보 technique: `Extract Class`, `Move Method`, `Extract Subclass`
...
- [[refactoring-guru-refactoring]] — https://refactoring.guru/smells/divergent-change
