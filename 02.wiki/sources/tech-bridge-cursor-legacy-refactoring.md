...
## ⚠️ 촬영 시점 추정에 대한 반증 증거 (2026-09-13 추가)

이 페이지(및 [[grok-4-6]])의 **"2026-09-01 무렵 촬영"** 추정은 두 고리로 이뤄져 있었다 — ① 발표자의 *"[[grok-4-6|Grok 4.6]]이 어제 출시됐다고 말하고 싶네요"*, ② [[tech-bridge-grokbot-agent-teams]]가 Grok 4.6을 **그 인터뷰 당일 발표**로 기록하고 그 인터뷰의 시점을 **Tech Bridge 업로드 날짜(2026-08-31)** 로 잡은 것.

**②가 약한 고리다.** 2026-09-12에 ingest한 [[tech-bridge-lauren-tan-trusting-agents]]는 같은 인물([[lauren-tan]])이 **Grok 4.6 발표 당일**에 한 워크숍인데, 거기서 화자가 **"이번 달은 아직 12일밖에 안 됐다"** 고 말한다(양 트랙 일치). **08-30·08-31은 12일이 아니다.**

이 위키는 2026-09-03에 **"업로드 날짜 ≠ 촬영 날짜"** 를 원칙으로 세웠는데 ②에는 적용되지 않았다.

→ **달을 확정할 근거가 없으므로 위 추정을 새 날짜로 갈아치우지 않는다.** 반증 증거만 나란히 둔다. 자세한 것은 [[tech-bridge-lauren-tan-trusting-agents]]의 시점 절.

## 같은 회사, 같은 주제의 다른 각도 (2026-09-12 편)

[[tech-bridge-lauren-tan-trusting-agents]]가 **왜 레거시를 옮겨야 하는가와 무엇으로 옮기는가**를 채운다. 그리고 **통념을 뒤집는다** — 가드레일이 있는 브라운필드는 오히려 에이전트에게 안전하고, 바이브 코딩된 그린필드가 가장 위험하다. → [[greenfield-vs-brownfield-agent-risk]] · [[organic-architecture]] · [[dune-architecture]]
