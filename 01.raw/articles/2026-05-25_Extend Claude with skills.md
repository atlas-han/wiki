...
### :LiPlay: Run and verify your app
...
## :LiRocket: Getting started

### :LiSparkles: Create your first skill
...
#### :LiActivity: Live change detection
...
#### :LiSearch: Automatic discovery from parent and nested directories
...
#### :LiFolderPlus: Skills from additional directories
...
### :LiClipboardList: Frontmatter reference
...
#### :LiCode: Available string substitutions
...
### :LiPaperclip: Add supporting files
...
### :LiLock: Control who invokes a skill
...
### :LiRefreshCw: Skill content lifecycle
...
### :LiCheckCircle: Pre-approve tools for a skill
...
### :LiArrowDownToLine: Pass arguments to skills
...
## :LiTarget: Advanced patterns

### :LiSyringe: Inject dynamic context
...
### :LiGitFork: Run skills in a subagent
...
#### :LiFlaskConical: Example: Research skill using Explore agent
...
### :LiBan: Restrict Claude’s skill access
...
### :LiEye: Override skill visibility from settings
...
### :LiPalette: Generate visual output
...
## :LiWrench: Troubleshooting

### :LiHelpCircle: Skill not triggering
...
### :LiAlertTriangle: Skill triggers too often
...
### :LiScissors: Skill descriptions are cut short
